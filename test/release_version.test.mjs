...
test("2.0.2 release surfaces agree on the runtime version", async () => {
  ...
  assert.match(launcher, /^version = "2.0.2"$/m);
  assert.match(gateway, /name: "CodexBridge Engine V2", version: "2.0.2"/);
});
